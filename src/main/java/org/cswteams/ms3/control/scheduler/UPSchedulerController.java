...
@Service
public class UPSchedulerController implements ISchedulerController {
    ...
    private UPScheduleBuilder scheduleBuilder; //TODO generalizzare?
    ...
    public Schedule createSchedule(LocalDate startDate, LocalDate endDate)  {
        ...
        try {
            this.scheduleBuilder = new UPScheduleBuilder(//TODO generalizzare
...
//TODO generalizzare (UPControllerScocciatura)
            this.scheduleBuilder.setControllerScocciatura(new UPControllerScocciatura(scocciaturaDAO.findAll()));
     ...
     */
    @Override
    public boolean recreateSchedule(long id) throws UnableToBuildScheduleException {
        ...
        //TODO rimuovere, è per far funzionare l'algoritmo (temporaneamente)
        boolean foo=false;
        if(foo) throw new UnableToBuildScheduleException("yo");
